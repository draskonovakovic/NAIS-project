...
public class MatchService {
    ...
    public Optional<Match> findMatchById(long id, LocalDateTime date, String city) {
        return matchRepository.findMatchByIdAndMatchDateTimeAndCity(id,date,city);
    }

    public Match updateMatch(long id, LocalDateTime date, String city, Match matchDetails) {
        return matchRepository.findMatchByIdAndMatchDateTimeAndCity(id,date,city).map(match -> {
    ...
    public void deleteMatchById(long id, LocalDateTime date, String city) {
        matchRepository.deleteMatchByIdAndMatchDateTimeAndCity(id,date,city);
    }
